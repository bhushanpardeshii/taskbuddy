...
const CreateTaskDialog = ({ isOpen, onOpenChange, onSubmit, initialData = {} }) => {
  ...
  return (
    <Dialog open={isOpen} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-[674px]">
        <DialogHeader>
          <div className="flex items-center py-4 justify-between border-b">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="space-y-2 bg-gray-100 rounded-xl border">
            ...
            <Textarea
              ...
              className="min-h-[100px] bg-gray-100 border-none resize-none"
          ...
          <div className="flex flex-col pb-16 pt-10 gap-2">
            <h1 >Attachment</h1>
